...
| Skill | Use when |
| --- | --- |
| [Solution Architecture Design](../skills/solution-architecture-design/SKILL.md) | Creating or updating a solution architecture design from a capability overview. |
...
- Solution architecture design documents under `solution-architectures/`.
