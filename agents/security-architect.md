...
| [Solution Architecture Design](../skills/solution-architecture-design/SKILL.md) | Reviewing security, privacy, compliance, observability, resilience, and operational design sections. |
...
```text
grill-me -> ubiquitous-language -> solution-architecture-design ->
