...
| [Solution Architecture Design](../skills/solution-architecture-design/SKILL.md) | Reviewing solution design completeness, risks, dependencies, and open questions. |

## Typical Skill Flow

```text
grill-me -> solution-architecture-design -> target-architecture-document ->
