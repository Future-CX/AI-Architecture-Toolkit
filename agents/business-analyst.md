...
| [Solution Architecture Design](../skills/solution-architecture-design/SKILL.md) | Reviewing whether solution design assumptions trace back to real business needs. |
