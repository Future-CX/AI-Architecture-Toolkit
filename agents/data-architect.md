...
| [High-Level Solution Design](../skills/high-level-solution-design/SKILL.md) | Creating or reviewing the data model, ownership, persistence, and interface sections. |
