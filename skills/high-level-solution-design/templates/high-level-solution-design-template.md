...
- [Source Capability Context](#source-capability-context)
...
| Decision     | Choice     | Alternatives considered     | Rationale     | Trade-offs     | ADR needed     |
| ------------ | ---------- | --------------------------- | ------------- | -------------- | -------------- |
| {{DECISION}} | {{CHOICE}} | {{ALTERNATIVES_CONSIDERED}} | {{RATIONALE}} | {{TRADE_OFFS}} | {{ADR_NEEDED}} |
